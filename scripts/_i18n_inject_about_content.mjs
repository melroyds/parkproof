...
const T = {
  'zh-CN': {
    ...
    footerNote: 'ParkProof 是开源项目 — 每一行代码都是公开的。墨尔本 Melroy D\'Souza 出品。',
  ...
  vi: {
    ...
    footerNote: 'ParkProof là mã nguồn mở — mọi dòng code đều công khai. Được xây dựng tại Melbourne bởi Melroy D\'Souza.',
  ...
  it: {
    ...
    footerNote: 'ParkProof è open source — ogni riga di codice è pubblica. Realizzato a Melbourne da Melroy D\'Souza.',
  ...
  el: {
    ...
    footerNote: 'Το ParkProof είναι ανοιχτού κώδικα — κάθε γραμμή του κώδικα είναι δημόσια. Φτιαγμένο στη Μελβούρνη από τον Melroy D\'Souza.',
  ...
  hi: {
    ...
    footerNote: 'ParkProof ओपन सोर्स है — हर कोड लाइन सार्वजनिक है। मेलबर्न में Melroy D\'Souza द्वारा बनाया गया।',
  ...
  pa: {
    ...
    footerNote: 'ParkProof ਓਪਨ ਸੋਰਸ ਹੈ — ਹਰ ਕੋਡ ਲਾਈਨ ਜਨਤਕ ਹੈ। ਮੈਲਬਰਨ ਵਿੱਚ Melroy D\'Souza ਦੁਆਰਾ ਬਣਾਇਆ ਗਿਆ।',
