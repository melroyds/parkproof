...
CALLBACK_URLS='["https://parkproof.dsouza.tech/auth/callback","https://d1jmpu2roekssu.cloudfront.net/auth/callback","http://localhost:5173/auth/callback"]'
LOGOUT_URLS='["https://parkproof.dsouza.tech/","https://d1jmpu2roekssu.cloudfront.net/","http://localhost:5173/"]'
