...
CALLBACK_URLS='["https://d1jmpu2roekssu.cloudfront.net/auth/callback","http://localhost:5173/auth/callback"]'
LOGOUT_URLS='["https://d1jmpu2roekssu.cloudfront.net/","http://localhost:5173/"]'
