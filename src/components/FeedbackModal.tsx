          ...
          <form onSubmit={handleSubmit} className="p-6 sm:p-8">
            <div className="flex items-start justify-between mb-2">
              ...
              <button
                ...
                onClick={onClose}
                disabled={submitting}
                className="text-ink-600 hover:text-ink-800 disabled:opacity-50 -mt-1 -mr-1 p-2 text-xl leading-none min-w-[44px] min-h-[44px] flex items-center justify-center"
            ...
            />
            {showCounter && (
              <p className="text-xs text-ink-600 text-right mt-1">
            ...
            >
              ...
              <span className="text-ink-600 font-normal ml-1">{t('feedback.emailOptional')}</span>
            </label>
            <input
              id="feedback-email"
              type="email"
